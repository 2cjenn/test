...
# Combine the apoe genetic data with all the other UKB data
apoe <- readRDS("K:\\TEU\\UKB_Genetic_Data\\SNP_Extraction_2019\\APOE_20191018\\extracted_files\\R\\gen_apoe.rds")
...
saveRDS(apoe, file=paste0(config$exclusions$apoe, "apoe_surv.rds"))