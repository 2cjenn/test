...
write.csv(level3, paste0(config$cleaning$organised, "CancerCodes.csv"), 
          na="", row.names=FALSE)

# And save it as an R data file, why not
saveRDS(level3, paste0(config$cleaning$organised, "CancerCodes.rds"))


#--------------------------------------------------------------------------------------------------------------
# Finally, join the coded participant data to the code labels

VI_diag <- readRDS(paste0(config$cleaning$organised, "VeI_cancer_base.rds"))
VI_diagdur <- readRDS(paste0(config$cleaning$organised, "VeI_cancerdur_base.rds"))
...
saveRDS(VI_diaglong, paste0(config$cleaning$organised, "VICancerCodes_long.rds"))



veint <- readRDS(paste0(config$cleaning$organised, "VICancerCodes_long.rds"))
# And merge
...
saveRDS(final, paste0(config$cleaning$organised, "Cancer_pts.rds"))
