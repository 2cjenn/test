...
write.csv(level4, paste0(config$cleaning$organised, "JobCodes.csv"), 
          na="", row.names=FALSE)

# And save it as an R data file, why not
saveRDS(level4, paste0(config$cleaning$organised, "JobCodes.rds"))
...
saveRDS(final, paste0(config$cleaning$organised, "JobCodes_pts.rds"))
