...
model1 <- coxph(Surv(time_to_dementia, dementia_status) ~ age + gender + e4carrier + controlled_, 
...
model1 <- coxph(Surv(time_to_dementia, dementia_status) ~ age + e4carrier + controlled_, 
                data=data[data$treated==TRUE & data$gender=="Female",])
kable(printcoxresults(model1), 
...
model1 <- coxph(Surv(time_to_dementia, dementia_status) ~ age + e4carrier + controlled_, 
                data=data[data$treated==TRUE & data$gender=="Male",])
kable(printcoxresults(model1), 
