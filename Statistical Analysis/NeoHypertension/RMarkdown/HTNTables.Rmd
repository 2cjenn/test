...
varlist <- c("c_age", "gender", "BMIcat", "Smo_Status", "GroupB", "GroupC", "HTNdx", "hypmedsno", "townsend_depind", "income", "ISCED", "employment", "BirthCountryIncomeLevel", "BowelCancerScreening")
...
tab3 <- regressiontable(df=treated, varlist=varlist, regresstype="multivariable")
kable(tab3)
