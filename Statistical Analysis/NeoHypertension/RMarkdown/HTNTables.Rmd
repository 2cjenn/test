...
for(df in dflist){
  ...
  tab2 <- rbind(tab2,(cbind(n, mean_age, paste0(mean_SBP,"/",mean_DBP), pct_control)))
}

tab2 <- cbind(c("All hypertensives", levels(treated$agegrp), levels(treated$eth_group),
...
colnames(tab2) <- c("", "n", "Mean age", "Mean SBP/DBP", "% Controlled")
kable(tab2)
