...
# Among white individuals, is PRS predictive of evidence of hypertension?

```{r prs_htn, include=TRUE, echo=FALSE}

varlist <- c("agegrp", "gender", "PRS_quint", pclist)
multi <- regressiontable(df=white, outcome="evidenceHTN", varlist=varlist, 
                         regresstype="multivariable")
...
Among white individuals receiving treatment for hypertension, is PRS predictive of successful control?
