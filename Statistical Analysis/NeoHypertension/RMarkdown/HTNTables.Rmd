...
![Hypertension defined as self-report of a prior diagnosis of hypertension in touchscreen questionnaire (TQ) or verbal interview (VI), or self-report of hypertensive medication in TQ or in VI by our rubric, or mean SBP >= 140 mmHg or mean DBP >= 90 mmHg at baseline assessment. Aware defined as self-report of a prior diagnosis of hypertension in TQ or VI, or self-report of hypertensive medication in TQ or in VI by our rubric. Treated defined as self-report of hypertensive medication in TQ or in VI by our rubric. Control defined among the treated as mean SBP >= 140 mmHg or mean DBP >= 90 mmHg at baseline assessment.](K:/TEU/APOE on Dementia/Statistical Analysis/NeoHypertension/RMarkdown/Wholepop.png){height=680px}
...
add_footnote(kable(tab1), label=c("Control defined as mean SBP >= 140 mmHg or mean DBP >= 90 mmHg at baseline assessment, among participants who self-reported treatment for hypertension either in TQ or in VI by our rubric",
                                  ...
                                  "BMI has been categorised according to the NHS guidance. Underweight: BMI < 18.5. Normal: 18.5 <= BMI < 25. Overweight: 25 <= BMI < 30. Obese: BMI >= 30.", 
...
add_footnote(kable(tab3), label=c("Number of individuals in levels of a categorical variable may not add up to total n because 'Do not know' and 'Prefer not to answer' categories have been removed from results table",
                                  ...
                                  "BMI has been categorised according to the NHS guidance. Underweight: BMI < 18.5. Normal: 18.5 <= BMI < 25. Overweight: 25 <= BMI < 30. Obese: BMI >= 30.", 
                                  "The total Metabolic Equivalent Task (MET) minutes per week is available from UKB as a derived variable based on self-reported frequency and duration of walking, moderate and vigorous activity. We have dichotomized based on the upper end of the WHO guideline range for weekly physical activity.",
                                  paste0("The number of self-reported conditions from the following list: ", paste(sapply(comorbs_string, prettyfunc,  pnames=pretty_names, lower=TRUE), collapse=", "), ".")
                                  ), notation="number")
