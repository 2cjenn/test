---
title: "Sensitivity analysis: Using 2nd BP measurement only (instead of average)"
...
# Figure `r figure`. Prevalence of hypertension, and its awareness, treatment and control among 40-69 year old adults in the UKB.
`r figure <- figure + 1`
...
# Table `r table`: Prevalence of hypertension control among treated hypertensives (n = `r nrow(treated)`), by socioeconomic and clinical characteristics.
`r table <- table + 1`
