...
comorbs_raw <- c("VI_afib_or_aflutter", "VI_CVD", "VI_diabetes", "VI_asthma_or_COPD", "VI_migraine", "VI_epilepsy",
                 "VI_anxiety_or_stress", "VI_depression_or_bipolar","VI_substance_use")
...
pretty_names <- list(agegrp = "Age group",
                     ...
                     weekly_alcunits = "Alcoholic drinks per week",
                     weekly_alccat = "Alcoholic drinks per week (categorical)",
                     PhA_METsWkAllAct = "Weekly physical activity, in METs",
                     METs_over150 = "Sufficient physical activity",
...
<div custom-style="Todo">To-do: Genetic ethnicity instead of self-reported</div>

```{r table1, include=TRUE, echo=FALSE}
varlist=c("age", "agegrp", "gender", "ethnicity",
          "townsend_quint", "income", "employment", "ISCED", "BirthCountryIncomeLevel", "countryResidence",
          "BMIcat", "Smo_Status", "weekly_alcunits", "weekly_alccat", "PhA_METsWkAllAct", "METs_over150",
...
<div custom-style="Todo">To-do: Investigate METs further - Neo to send definition?</div>

<div custom-style="Todo">To-do: Investigate possibility of correlation between Townsend/income/education/employment</div>

<div custom-style="Todo">To-do: Add employment back in when David sends condensed categories</div>
...
varlist=c("agegrp", "gender", "ethnicity",
          ...
          "BMIcat", "Smo_Status", "weekly_alccat", "METs_over150",
          "antiHTNmedsno",  "FamilyHist_CVD_",
          "comorbNumber_", comorbs_string,
           "BowelCancerScreening")

adj <- regressiontable(df=treated, varlist=varlist, regresstype="adjusted", adjvarlist=c("agegrp", "gender"))
