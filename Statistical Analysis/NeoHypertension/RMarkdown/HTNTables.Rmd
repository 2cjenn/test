...
# Figure 2. Prevalence of hypertension, and its awareness, treatment and control among adults aed 40-69 years in the UKB (n = `r nrow(data)`).
...
# Table 2: Prevalence of hypertnesion awareness, treatment and control among hypertensives, by socioeconomic characteristics and comorbidity type
...
tab2 <- merge(adj, multi, by=c("IDcol", "Coefficient", "Level"), sort=FALSE)
tab2 <- tab2[,-which(names(tab2)=="IDcol")]
tab2 <- rbind(c("Coefficient", "Level", "OR", "95% CI", "p", "OR", "95% CI", "p"),
              tab2)
colnames(tab2) <- c("","", "Age- and sex-adjusted", "", "", "Fully adjusted", "", "")
