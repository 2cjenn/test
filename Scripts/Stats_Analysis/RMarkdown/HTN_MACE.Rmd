...
# Hypertension PRS prospective analysis WITH MEASURED SBP
...
# Hypertension PRS prospective analysis WITHOUT MEASURED SBP

## Cox regression of time until MACE event (`r nrow(data[!is.na(data$TEU_MACE_fucomp),])` events)

```{r Cox model mace 2, echo=FALSE}
...
```{r Cox model stroke 2, echo=FALSE}
