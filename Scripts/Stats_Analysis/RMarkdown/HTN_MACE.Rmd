...
Including measured SBP at baseline (quintiles) and SBP PRS (quintiles)
...
# # age- and sex-adjusted
# agesex <- coxph(Surv(TEU_MACE_time_yrs,TEU_MACE_MI) ~ TEU_BaC_AgeCat + BaC_Sex, data=data)
...
#   formula <- as.formula(paste0("Surv(TEU_MACE_time_yrs,TEU_MACE_MI) ~ TEU_BaC_AgeCat + BaC_Sex + ", var))
...
varlist=c("TEU_BaC_AgeCat", "BaC_Sex", "TEU_BlP_SBP_quintiles", "TEU_SBP_PRS_quintiles",
          "TEU_BSM_BMIcat", "TEU_Smo_Status", "TEU_Alc_WeeklyCat", "TEU_Pha_METsover1200",
          "TEU_FaH_CVD", "Prosp_comorb_numcat", "TEU_VeI_numHTNmedscat", "TEU_LDL_Quintiles",
          "TEU_TownsendDepInd_Quint", "TEU_HouseholdIncome", "TEU_Emp_category", "TEU_Edu_ISCED", "TEU_Rec_Country",
          "GeP_PC_1", "GeP_PC_2", "GeP_PC_3", "GeP_PC_4"
