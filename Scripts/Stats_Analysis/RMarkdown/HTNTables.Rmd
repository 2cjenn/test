...
**Note: do we want to exclude participants who had already experienced a cardiac outcome prior to baseline? Or do we want to include them, tracking time until their first *post-baseline* cardiac outcome**
...
kable(printcoxresults(df=data, surv=surv, 
                      varlist=c("age", "gender", "controlled_"), 
