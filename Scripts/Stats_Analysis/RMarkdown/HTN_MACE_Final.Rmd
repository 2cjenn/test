...
if(live) {
  ...
  imp1 <- readRDS(file.path(config$data$derived, "imputation30March2021.rds"))
}
```
...
## Table `r table`. Descriptive statistics of analysis population by systolic BP PRS quintiles (N = `r nrow(data)`).
`r table <- table + 1`
...
tab_1 <- descriptivetable(df=data[data$TEU_SBP_PRS_quintiles=="Q1: Lowest score",], 
                         varlist=varlist,
                         contavg='median',
...
tab_5 <- descriptivetable(df=data[data$TEU_SBP_PRS_quintiles=="Q5: Highest score",], 
                         varlist=varlist,
                         contavg='median',
                         pretty_names=pretty_names,
                         singlecol=TRUE)
...
rownames(tab) <- NULL
                   ...
                   paste0("Q1: Lowest score (N=", nrow(data[data$TEU_SBP_PRS_quintiles=="Q1: Lowest score",]), ")"), 
                   paste0("Q3 (N=", nrow(data[data$TEU_SBP_PRS_quintiles=="Q3",]), ")"), 
                   paste0("Q5: Highest score (N=", nrow(data[data$TEU_SBP_PRS_quintiles=="Q5: Highest score",]), ")"))
