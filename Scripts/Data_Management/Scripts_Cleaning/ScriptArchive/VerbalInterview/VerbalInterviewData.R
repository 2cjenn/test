...
veint <- readRDS(file.path(config$data$received, "VeI_base.rds"))
...
saveRDS(VI_diag, file.path(config$data$derived, "VeI_diag_base.rds"))
saveRDS(VI_diagdur, file.path(config$data$derived, "VeI_diagdur_base.rds"))
...
saveRDS(VI_cancer, file.path(config$data$derived, "VeI_cancer_base.rds"))
saveRDS(VI_cancerdur, file.path(config$data$derived, "VeI_cancerdur_base.rds"))
...
saveRDS(VI_medcode, file.path(config$data$derived, "VeI_medcodes_base.rds"))
...
saveRDS(VI_operation, file.path(config$data$derived, "VeI_operation_base.rds"))
saveRDS(VI_opdur, file.path(config$data$derived, "VeI_opdur_base.rds"))

#--------------------------------------------------------------------------------------------------------------
# Add country names to the remaining verbal interview data
# Load the long-format verbal interview data
countries <- readRDS(file.path(config$data$derived, "CountryIncome.rds"))
# And merge
...
saveRDS(veint, file.path(config$data$derived, "VeIcovars_base.rds"))
