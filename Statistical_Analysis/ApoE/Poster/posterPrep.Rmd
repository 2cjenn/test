...
education$edu_highest <- factor(education$edu_highest, levels=c("Other professional qualifications eg: nursing, teaching", "College or University degree", "NVQ or HND or HNC or equivalent", "A levels/AS levels or equivalent", "O levels/GCSEs or equivalent", "CSEs or equivalent", "None of the above", "Prefer not to answer"))
